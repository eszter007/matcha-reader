...
class AtkinsonDitherer {
 public:
  // makeUniqueNoThrow, never bare new: under -fno-exceptions a failed allocation aborts the
  // firmware rather than returning null, and manga BMP pages are large enough to reach that.
  // isValid() lets the owner fail the parse instead.
