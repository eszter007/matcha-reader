...
void IntervalSelectionActivity::loop() {
  ...
  buttonNavigator.onPressAndContinuous({MappedInputManager::Button::ScreenLeft}, [this] { adjustValue(-smallStep); });
  buttonNavigator.onPressAndContinuous({MappedInputManager::Button::ScreenRight}, [this] { adjustValue(smallStep); });
  ...
  buttonNavigator.onPressAndContinuous({MappedInputManager::Button::ScreenUp},
                                       [this, upDelta] { adjustValue(upDelta); });
